...
<footer>
                ...
                <g fill="none" fill-rule="evenodd">
                  <g transform="translate(0 -75)">
                    <g transform="translate(0 75)">
                      ...
                      <div>
        <img width="800" height="200" src="https://dircom.unah.edu.hn/dmsdocument/17472-sellos-acreditacion-blanco"></img>
    </div>
    <br/>
                    </g>
                    <text fill="white" font-family="Nunito-Bold, Nunito" font-size="800" font-weight="bold">
                      <tspan x="400" y="600" font-size= "800">UNIVERSIDAD NACIONAL AUTONÓMA DE HONDURAS</tspan>
                    </text>
                  </g>
                </g>
          ...
          <div className="px-4 my-4 w-full sm:w-auto">
            <div>
              <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Información</h2>
            </div>
            <ul className="leading-8">
              <li><a href="#" className="hover:text-blue-400">Sobre nosotros</a></li>
              <li><a href="#" className="hover:text-blue-400">Terminos &amp; Condiciones</a></li>
              <li><a href="#" className="hover:text-blue-400">Privacidad y politicas</a></li>
          ...
          <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
            <div>
              <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Contáctanos</h2>
            </div>
    ...
    <div className="bg-yellow-400 py-4 text-gray-100">
